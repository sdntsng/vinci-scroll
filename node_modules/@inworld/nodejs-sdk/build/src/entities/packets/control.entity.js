...
class ControlEvent {
    ...
    static fromProto(proto) {
        ...
        return new ControlEvent(Object.assign(Object.assign(Object.assign({ action: this.getControlType(proto) }, (audioSessionStart && {
            audioSessionStart: {
                mode: ControlEvent.getMicrophoneMode(audioSessionStart),
                understandingMode: ControlEvent.getUnderstandingMode(audioSessionStart),
            },
        })), { description: proto.getDescription() }), (conversation && {
    ...
    static getControlType(proto) {
        switch (proto.getAction()) {
            case packets_pb_1.ControlEvent.Action.AUDIO_SESSION_START:
                return data_structures_1.InworlControlAction.AUDIO_SESSION_START;
            case packets_pb_1.ControlEvent.Action.AUDIO_SESSION_END:
                return data_structures_1.InworlControlAction.AUDIO_SESSION_END;
    ...
    static getMicrophoneMode(proto) {
        if (proto.getMode() ===
            packets_pb_1.AudioSessionStartPayload.MicrophoneMode.EXPECT_AUDIO_END) {
            return data_structures_1.MicrophoneMode.EXPECT_AUDIO_END;
        }
        return data_structures_1.MicrophoneMode.OPEN_MIC;
    }
    static getUnderstandingMode(proto) {
        if (proto.getUnderstandingMode() ===
            packets_pb_1.AudioSessionStartPayload.UnderstandingMode.SPEECH_RECOGNITION_ONLY) {
            return data_structures_1.UnderstandingMode.SPEECH_RECOGNITION_ONLY;
        }
        return data_structures_1.UnderstandingMode.FULL;
    }
}
