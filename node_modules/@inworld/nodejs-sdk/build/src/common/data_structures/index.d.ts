import { CapabilitiesConfiguration, ClientConfiguration as ControlClientConfiguration, SessionConfiguration, UserConfiguration } from '../../../../proto/ai/inworld/engine/configuration/configuration_pb';
import { Continuation, InworldPacket as ProtoPacket } from '../../../../proto/ai/inworld/packets/packets_pb';
...
export declare enum InworldTextPacketType {
    UNKNOWN = "UNKNOWN",
...
export declare enum InworlControlAction {
    UNKNOWN = "UNKNOWN",
...
export declare enum InworldConversationEventType {
    UNKNOWN = "UNKNOWN",
    STARTED = "STARTED",
    UPDATED = "UPDATED",
    EVICTED = "EVICTED"
}
export declare enum InworldLatencyReportType {
    PERCEIVED_LATENCY = "PERCEIVED_LATENCY",
    PING_PONG = "PING_PONG"
}
export declare enum ConversationIntializeState {
    ACTIVE = "ACTIVE",
    PROCESSING = "PROCESSING",
    INACTIVE = "INACTIVE"
}
...
export declare enum UnderstandingMode {
    FULL = "FULL",
...
export declare enum ConversationParticipant {
    USER = "USER"
}
...
export declare enum ItemsInEntitiesOperationType {
    ADD = "ADD",
    REMOVE = "REMOVE",
    REPLACE = "REPLACE"
}
...
export type ProtobufValue = string | number | boolean | null | undefined | ProtobufValue[] | {
